...
formInOptionsPage.addEventListener("submit", (event) => {
  ...
  localStorage.setItem("showwcase-username", username);
...
const apiKey = localStorage.getItem("showwcase-api-key");
if (apiKey) {
  apiKeyInputOptionsPage.value = apiKey;
}

// Retrieve username from local storage
const username = localStorage.getItem("showwcase-username");
if (username) {
  usernameInputOptionsPage.value = username;
}
//! Options Page JS END
